...
dealer_insert_batch = "INSERT INTO batch (batch_id, model_id, mac_key_share, shares_seed, mac_key_mask) \
                        VALUES (%s, %s, %s, %s, %s)"
mo_insert_batch = "INSERT INTO batch (batch_id, model_id, mac_key_share, shares_delivered)\
                    VALUES (%s, %s, %s, %s)"
client_insert_batch = "INSERT INTO batch (batch_id, model_id, mac_key_share)\
                        VALUES (%s, %s, %s)"
